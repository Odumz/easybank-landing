    ...
    <div class="lg:flex lg:space-x-36 items-center justify-center">
      ...
      <div class="grid lg:flex gap-4 lg:gap-8 text-white">
        <div class="grid lg:text-left gap-y-5">
          ...
          <a class="hover:text-lime-green" href="#blog">Blog</a>
        </div>
        <div class="grid lg:text-left gap-y-5">
          <a class="hover:text-lime-green" href="#careers">Careers</a>
          <a class="hover:text-lime-green" href="#support">Support</a>
          <a class="hover:text-lime-green" href="#privacypolicy"
            >Privacy Policy</a
          >
        </div>
      </div>
